...
public class Util {
    ...
    public static float createOrderNum() {
        AtomicLong sequence = new AtomicLong(System.currentTimeMillis() / 1000);
    ...
    public static void sendEmail(String to, float orderNum, boolean bodyIsHTML)
        ...
        String subject = "Order Confirmation #"+df.format(orderNum);
